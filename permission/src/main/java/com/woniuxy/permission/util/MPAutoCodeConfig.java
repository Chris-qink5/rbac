package com.woniuxy.permission.util;
...
public class MPAutoCodeConfig {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"\\permission\\src\\main\\java");         //自定义代码生成后的存放目录
        gc.setAuthor("qinkui");                            //设置项目作者
        ...
        dsc.setUrl("jdbc:mysql:///rbac?characterEncoding=utf-8");
        ...
        pc.setParent("com.woniuxy.permission");                            //设置模块中的父目录名
        ...
        // 设置要生成的实体类对应映射的表名
        strategy.setInclude("permission","role","user");
